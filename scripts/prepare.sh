...
clone_project https://github.com/MaxGavr/set-ostis-drawings.git set-ostis-drawings master
...
clone_project https://github.com/MaxGavr/gt-knowledge-base.git kb/graph_theory/gt-knowledge-base master
